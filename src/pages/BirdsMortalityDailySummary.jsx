...
export default function BirdsMortalityDailySummary() {
    ...
    const fetchDailySummary = async () => {
        try {
            ...
            const response = await api.get('/birds-mortality/daily-summary', { params });
            if (response.data.success) {
                setData(response.data.data);
            }
        } catch (err) {
            console.error('Error fetching birds mortality daily summary:', err);
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Birds_Mortality_Daily_Summary_${month}_${year}.xlsx`);
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                            ...
                            Birds Mortality - Daily Breakdown
                        </h1>
